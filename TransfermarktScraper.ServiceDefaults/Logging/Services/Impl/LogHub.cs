...
{
    /// <summary>
    /// SignalR hub used for broadcasting logs to be visualized in real-time in the UI.
    /// </summary>
    public class LogHub : Hub
    {
        ...
        /// </summary>
        /// <param name="logStorageService">The service responsible for retrieving stored logs.</param>
        ...
        /// This method retrieves all previously stored logs and sends them to the connected client.
        /// </summary>
