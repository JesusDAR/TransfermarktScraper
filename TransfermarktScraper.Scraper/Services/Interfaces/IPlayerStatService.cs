...
namespace TransfermarktScraper.Scraper.Services.Interfaces
{
    ...
    public interface IPlayerStatService
    {
        ...
        public Task<IEnumerable<PlayerStatResponse>> GetPlayerStatsAsync(IEnumerable<PlayerStatRequest> playerStatRequests, CancellationToken cancellationToken = default);
